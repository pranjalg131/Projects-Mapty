...
class App {
  ...
  _loadMap(pos) {
    ...
    // To set markers after retrieving from local storage
  ...
  _hideForm() {
    ...
    inputCadence.value =
      ...
      inputElevation.value =
        "";
    // This alone will cause the animation to be there
    // form.classList.add("hidden");

    // This will result in the form instantly gone , without the animation.
